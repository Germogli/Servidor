 ...
 * También genera los tokens JWT para los usuarios autenticados y los coloca en cookies seguras.
 */
@Service
...
public class AuthService {
     ...
     * Para mantener compatibilidad, también devuelve un objeto con información del usuario.
     *
    ...
    /**
     * Mantiene el método original de login para compatibilidad con código existente.
     * Pero no establece cookies, solo devuelve el token en la respuesta.
     *
     * @param request DTO con las credenciales del usuario.
    ...
    /**
     * Mantiene el método original de registro para compatibilidad con código existente.
     *
     * @param request DTO con los datos de registro.
     * @return DTO con el token JWT.
     */
    ...
    /**
     *Método de registro de administradores.
     *
     * @param request DTO con los datos de registro.
     * @return DTO con el token JWT.
     */
