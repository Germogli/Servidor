    ...
    public class CommunitySharedService {
        ...
        /**
         * Valida que un hilo exista en el sistema.
         * @param threadId Identificador del hilo
         * @throws ResourceNotFoundException si el hilo no existe
         */
        public void validateThreadExists(Integer threadId) {
            if (threadId != null && !threadRepository.existsById(threadId)) {
                throw new ResourceNotFoundException("Hilo no encontrado con id: " + threadId);
            }
        }
